...
Although we are quite strict at home with YouTube usage... we have to thank the "[The Q Español](https://www.youtube.com/@TheQ_Espa%C3%B1ol)" channel for the inspiration for this project, as that’s where José found [the video that guided us](https://www.youtube.com/watch?v=TrRz8SUba2s&ab_channel=TheQEspa%C3%B1ol).
...
[![Soda box template](/img/blogs/creamos-una-maquina-de-refrescos/sujetadores.png)](/img/blogs/creamos-una-maquina-de-refrescos/sujetadores.png)
...
[![Soda box button openings](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-pulsadores-de-la-caja-refrescos.png)](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-pulsadores-de-la-caja-refrescos.png)
...
[![Sealed cap photo](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-de-la-caja-refrescos-y-tubo.png)](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-de-la-caja-refrescos-y-tubo.png)
...
* [How to graphically represent an electrical circuit?](#how-to-graphically-represent-an-electrical-circuit)
* [What power source to use?](#what-power-source-to-use)
* [What electrical wire gauge to use?](#what-electrical-wire-gauge-to-use)
...
[![Connection insulation reinforcement](/img/blogs/creamos-una-maquina-de-refrescos/refuerzo-aislante-conexiones.png)](/img/blogs/creamos-una-maquina-de-refrescos/refuerzo-aislante-conexiones.png)
...
![](/img/blogs/creamos-una-maquina-de-refrescos/foto-tripas-maquina-de-refrescos.jpg)
...
<!-- 
https://www.youtube.com/watch?v=vEqmbPE-TF0
 -->
...
* In 2019, I also collaborated with [Technovation Families](https://photos.app.goo.gl/nnQvqzBFJKJQuQPQ9), although I suppose he didn’t quite understand it, we [trained an AI together to recognize dogs and other things](https://www.youtube.com/@RaulJimenezOrtega/search).
* In 2022, we made a basic design of a [Minecraft character in Blender](https://x.com/hhkaos/status/1564189181416439815/photo/1).
* Last year (2024), we published his first game on his Scratch profile ([Basket pong](https://scratch.mit.edu/projects/992463134/)), and also worked on OctoStudio, where I introduced him to the concept of variables for the first time.
* And last Christmas, we also made a mini video montage with his cousins ("Excursion to the Calahonda Mines"), in addition to assembling and programming the [mBot](https://www.amazon.es/Makeblock-programable-codificaci%C3%B3n-Educativo-Bluetooth/dp/B07XR98YYQ/ref=sr_1_1_sspa?dib=eyJ2IjoiMSJ9.rufDjeFexjuCHAVo_XrDdlFQcmxBQvzIhxdP5rOHYGzGaOiUc1XmWUgtz7vbMOu8XbEsRsvWyaxutzCKAbv9Y7GAd9OUX6O0-SvSxwm27oqL8SSXbVU2BSEGD9mBGsrKsOn_cnYi_BFxq7284vKa50-2lOiXgKXwc50GNhyKvkrGoDG2EtkvY15kvSbmv5dkUyUu4bayaMp_SoeqV90oxpg88GbtDFZ9WWm68hFxxAi0qwqlfT08lWdd715ZVRwj8B40y7_KGHcrjKi9k5oVQfkU-l7be3oW4b_dJo64ud8.YbYewLLCaZbecebntHpgkEZHY4c_r9ffyrBCfKArUx0&dib_tag=se&keywords=mBot&qid=1739063313&sr=8-1-spons&ufe=app_do%3Aamzn1.fos.8f1d93f5-43fb-442d-acba-8640975a5f7e&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1) that Santa Claus brought him.
