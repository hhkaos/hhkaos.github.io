...
![Materiales para fabricar una máquina de refrescos](/img/blogs/creamos-una-maquina-de-refrescos/materiales-para-fabricar-una-maquina-de-refrescos.png)
...
[![Plantilla caja de refrescos](/img/blogs/creamos-una-maquina-de-refrescos/plantilla-caja-refrescos-lateral.png)](/img/blogs/creamos-una-maquina-de-refrescos/plantilla-caja-refrescos-lateral.png)
...
[![Plantilla caja de refrescos](/img/blogs/creamos-una-maquina-de-refrescos/sujetadores.png)](/img/blogs/creamos-una-maquina-de-refrescos/sujetadores.png)
...
[![Plantilla caja de refrescos](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-pulsadores-de-la-caja-refrescos.png)](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-pulsadores-de-la-caja-refrescos.png)
...
[![Foto del tapón sellado](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-de-la-caja-refrescos-y-tubo.png)](/img/blogs/creamos-una-maquina-de-refrescos/aperturas-de-la-caja-refrescos-y-tubo.png)
...
[![Plantilla caja de refrescos](/img/blogs/creamos-una-maquina-de-refrescos/refuerzo-aislante-conexiones.png)](/img/blogs/creamos-una-maquina-de-refrescos/refuerzo-aislante-conexiones.png)
...
:::info PARA ENSAMBLAR NECESITARÉIS
...
* En 2019 también colaboré con [Technovation Families](https://photos.app.goo.gl/nnQvqzBFJKJQuQPQ9), aunque supongo que no se enteraba de nada, [entrenamos una IA juntos para identificar perros y otras cosas](https://www.youtube.com/@RaulJimenezOrtega/search).
* En 2022 hicimos un diseño básico de un [personaje de Minecraft en Blender](https://x.com/hhkaos/status/1564189181416439815/photo/1).
* El año pasado (2024), publicamos su primer juego en su perfil de Scrach ([Basket pong](https://scratch.mit.edu/projects/992463134/)), y también hicimos en OctoStudio donde le introduje por primera vez el concepto de variables.
* Y estas navidades pasadas, también hicimos un mini montaje en vídeo con sus primos ("Excursión a las minas de Calahonda"), además de montar y programar el [mBot](https://www.amazon.es/Makeblock-programable-codificaci%C3%B3n-Educativo-Bluetooth/dp/B07XR98YYQ/ref=sr_1_1_sspa?dib=eyJ2IjoiMSJ9.rufDjeFexjuCHAVo_XrDdlFQcmxBQvzIhxdP5rOHYGzGaOiUc1XmWUgtz7vbMOu8XbEsRsvWyaxutzCKAbv9Y7GAd9OUX6O0-SvSxwm27oqL8SSXbVU2BSEGD9mBGsrKsOn_cnYi_BFxq7284vKa50-2lOiXgKXwc50GNhyKvkrGoDG2EtkvY15kvSbmv5dkUyUu4bayaMp_SoeqV90oxpg88GbtDFZ9WWm68hFxxAi0qwqlfT08lWdd715ZVRwj8B40y7_KGHcrjKi9k5oVQfkU-l7be3oW4b_dJo64ud8.YbYewLLCaZbecebntHpgkEZHY4c_r9ffyrBCfKArUx0&dib_tag=se&keywords=mBot&qid=1739063313&sr=8-1-spons&ufe=app_do%3Aamzn1.fos.8f1d93f5-43fb-442d-acba-8640975a5f7e&sp_csd=d2lkZ2V0TmFtZT1zcF9hdGY&th=1) que le trajo Papá Noel.
